<template>
  <div>
    <h1 class="my-10 block text-center leading-8 font-extrabold tracking-tight text-gray-600 text-2xl"> How to show CTAs within and after videos in Nuxt.Js</h1>
    ...
    <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto leading-10 w-2/3 mx-auto">
      The above video will show two call to actions:
      <br/>
      <b>View on Pexels:</b> When the percentage played is greater than 20% but less than 70%
      <br/>
      <b>Free Stock Videos:</b> When the video is either paused or ends
    </div>
  </div>
</template>
